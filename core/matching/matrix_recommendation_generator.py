...
class MatrixRecommendationGenerator:
    ...
    def _check_bull_data_quality(self):
        ...
        regular_bulls = len(self.bull_data[self.bull_data['semen_type'] == '常规'])
        sexed_bulls = len(self.bull_data[self.bull_data['semen_type'] == '性控'])
        ...
        valid_regular = len(valid_bulls[valid_bulls['semen_type'] == '常规'])
        valid_sexed = len(valid_bulls[valid_bulls['semen_type'] == '性控'])
    ...
    def generate_matrices(self, progress_callback=None) -> Dict[str, pd.DataFrame]:
        ...
        # 分别处理常规和性控公牛
        regular_bulls = valid_bull_data[valid_bull_data['semen_type'] == '常规']
        sexed_bulls = valid_bull_data[valid_bull_data['semen_type'] == '性控']
    ...
    def _generate_recommendation_summary(self, progress_callback=None) -> pd.DataFrame:
        ...
        # 分别处理常规和性控公牛
        regular_bulls = self.bull_data[self.bull_data['semen_type'] == '常规']
        sexed_bulls = self.bull_data[self.bull_data['semen_type'] == '性控']
