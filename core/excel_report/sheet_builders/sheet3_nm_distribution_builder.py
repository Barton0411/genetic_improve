    ...
    def build(self, data: dict):
        ...
        try:
            ...
            if detail_df is not None and not detail_df.empty:
                ...
                self._create_normal_distribution_chart(present_detail_df, 'NM$_score', "在群母牛NM$正态分布",
            ...
            if all_df is not None and not all_df.empty:
                ...
                if detail_df is not None and not detail_df.empty:
                    ...
                    self._create_normal_distribution_chart(all_detail_df, 'NM$_score', "全部母牛NM$正态分布",
