...
### Excel综合报告 (v1.2.0.8-v1.2.0.9)
**已完成Sheet (9/11):**
- [x] Sheet 1: 牧场基础信息（含2个饼图、柱状图）
- [x] Sheet 1A: 牧场牛群原始数据
- [x] Sheet 2: 系谱识别分析（含3个饼图）
- [x] Sheet 2明细: 全群母牛系谱识别明细
- [x] Sheet 3: 育种性状分析（含正态分布图、折线图）
- [x] Sheet 4: 母牛指数分析（含分布图表）
- [x] Sheet 5: 配种记录-隐性基因分析（2个汇总表）
- [x] Sheet 6: 配种记录-近交系数分析（分布表+4个图表+趋势）
- [x] Sheet 7: 配种记录-隐性基因及近交系数明细
...
### v1.2.0.4-v1.2.0.7 (2025-10-07-2025-10-10)
- ✅ API地址统一
- ✅ 缺失公牛上传优化
- ✅ 用户提示简化
- ✅ 文档系统建立
...
- ✅ 修复选配库存检查逻辑
- ✅ 优化_collect_semen_counts()方法支持按冻精类型收集
- ✅ 允许只有一种冻精类型有库存时也可以选配
