...
| 1A | 牧场牛群原始数据 | ✅ 已完成 | 原始母牛数据明细 |
| 2 | 系谱识别分析 | ✅ 已完成 | 汇总表 + 3个饼图 |
| 2明细 | 全群母牛系谱识别明细 | ✅ 已完成 | 系谱识别明细表 |
| 3 | 育种性状分析 | ✅ 已完成 | 4个子sheet（年份汇总+分布+明细+对比） |
| 4 | 母牛指数分析 | ✅ 已完成 | 2个子sheet（分布+明细） |
| 5 | **配种记录-隐性基因分析** | ✅ 已完成 | 2个汇总表（全部年份+近12个月） |
| 6 | **配种记录-近交系数分析** | ✅ 已完成 | 2个分布表+4个图表+年份趋势表 |
| 7 | **配种记录-隐性基因及近交系数明细** | ✅ 已完成 | 配种记录明细表（原始数据） |
| 8 | **已用公牛性状汇总分析** | ⭐新规划 | 过去5年汇总表 + 各性状折线图 |
| 9 | **已用公牛性状明细** | ⭐新规划 | 按年份/类型分多个明细表 |
| 10 | **备选公牛排名** | ⭐新规划 | 按育种指数排名 + 主要性状值 |
| 11 | **选配推荐结果** | ⭐新规划 | 选配推荐明细表 |

---

## 📋 待实现Sheet详细设计

### Sheet 5: 配种记录-隐性基因分析 ⭐新规划
