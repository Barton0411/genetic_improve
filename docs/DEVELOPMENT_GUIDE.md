...
| 版本 | 日期 | 变更内容 | 负责人 |
|------|------|----------|---------|
| v1.0 | 2025-09-17 | 初始版本创建，定义整体开发规范和任务清单 | Claude |
| v1.1 | 2025-09-17 | 添加用户注册功能完成记录，更新API化改造状态 | Claude |
| v1.1.0.1 | 2025-09-19 | API架构重构完成：移除SQLAlchemy依赖，使用PyMySQL直接连接数据库，解决事务管理问题 | Claude |
