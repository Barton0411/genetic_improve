...
class ProgressDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.initUI()
        print("[DEBUG-PROGRESS-1] 创建进度对话框")

    def initUI(self):
        print("[DEBUG-PROGRESS-2] 初始化进度对话框UI")
    ...
    def update_progress(self, value):
        """更新进度条"""
        print(f"[DEBUG-PROGRESS-3] 更新进度: {value}%")
    ...
    def update_info(self, info):
        """更新信息区域"""
        print(f"[DEBUG-PROGRESS-4] 更新信息: {info}")
    ...
    def set_task_info(self, info):
        """设置当前任务信息"""
        print(f"[DEBUG-PROGRESS-5] 设置任务信息: {info}")
        self.task_label.setText(info)
        QApplication.processEvents()

    def on_cancel(self):
        """取消操作"""
        print("[DEBUG-PROGRESS-6] 用户取消操作")
